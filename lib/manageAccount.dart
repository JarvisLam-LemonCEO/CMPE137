      ...
      builder: (context, snapshot) {
        ...
        return Scaffold(
          appBar: AppBar(
            title: Text(
              'Manage Account',
              style: TextStyle(color: Colors.black, fontFamily: 'BalooBhai2', fontSize: 30), // Set title text color to white
            ),
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      child: Text(
                        'Change Password',
                        style: TextStyle(color: Colors.black, fontFamily: 'BallBhai2', fontSize: 20),
                      ),
